...
const displayCatergory = categories => {
    ...
    categories.forEach(category => {
        ...
        div.innerHTML = `
         <button class="tab-sm p-4 w-3/5 md:w-full justify-center flex items-center m-1 border border-ghost drop-shadow-md rounded" onclick="loadNews('${category.category_id}','${category.category_name}')"> ${category.category_name} </button>
    `
